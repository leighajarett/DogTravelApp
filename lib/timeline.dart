...
class _TimelineState extends State<Timeline> {
  ...
  String createLabel(Placemark? placemark) {
    String label = '';
    if (placemark!.administrativeArea != null &&
        placemark.administrativeArea!.isNotEmpty) {
      label = placemark.administrativeArea!;
    }
    if (placemark.subAdministrativeArea != null &&
        placemark.subAdministrativeArea!.isNotEmpty) {
      if (label.isNotEmpty) {
        label = "${placemark.subAdministrativeArea!}, $label";
      } else {
        label = placemark.subAdministrativeArea!;
      }
    }
    return label;
  }
  ...
  _displayDialog(BuildContext context) async {
    final prefs = await SharedPreferences.getInstance();
    final currentLabel = prefs.getString(events[currentEvent].photo.id);
    final myController = TextEditingController(text: currentLabel);
    final placemark = await events[currentEvent].getPlacemark();
    final label = createLabel(placemark);
    ...
    _saveDescription() async {
      prefs.setString(events[currentEvent].photo.id, myController.text);
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(style: const TextStyle(fontSize: 12), label),
                    ],
                  ),
                ),
              ),
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  cursorColor: const Color(0xffb7c245),
              ...
              Align(
                ...
                child: OutlinedButton(
                    ...
                    child: const Text(
                      'Save',
                      style: TextStyle(color: Color(0xffb7c245), fontSize: 12),
                    )),
              )
            ]),
          ));
